    ...
    <section class="mx-auto max-w-7xl px-4 pb-24 sm:px-6 lg:px-8">
        ...
        <div class="mt-8 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            @forelse ($events as $event)
                <div class="card-hover glass rounded-2xl p-6" data-reveal>
        ...
        <div class="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            @forelse ($members as $member)
                <div class="card-hover glass rounded-2xl p-6 text-center" data-reveal>
                    ...
                    @if ($member->cv_last_generated_at)
                        <a href="{{ route('cv.show', $member->username) }}" class="mt-4 inline-block text-sm font-semibold text-brand-300 hover:text-brand-200">View CV ↗</a>
                    @endif
                </div>
            @empty
