...
<body class="font-sans text-gray-800 antialiased" onload="lucide.createIcons()">
    ...
    <header class="sticky top-0 z-50 bg-white shadow-lg/50 backdrop-blur-sm">
        <nav class="container mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
            <a href="#" class="text-3xl font-extrabold text-blue-950"><img height="50px" width="50px" src="logo.png" alt="Mykaeltech Logo">Mykael<span class="text-blue-600">tech</span></a>
